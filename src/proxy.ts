...
const PUBLIC_PATHS = ["/login", "/landing", "/pricing", "/terms", "/privacy", "/credits", "/api/auth/login", "/api/auth/signup", "/api/auth/forgot-password", "/api/auth/reset-password", "/api/auth/resend-verification", "/api/auth/verify-email", "/api/waitlist", "/invite/", "/verify-email/", "/forgot-password", "/reset-password/", "/check-email", "/opengraph-image"];
