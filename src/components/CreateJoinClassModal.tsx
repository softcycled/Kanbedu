        ...
        {mode === "options" && (
          <div>
            ...
            <div className="mt-6 grid gap-3">
              <button onClick={() => setMode("create")} className="w-full px-4 py-3 rounded-xl text-sm font-medium bg-ink text-card-bg hover:opacity-95 transition-opacity">Create class</button>
