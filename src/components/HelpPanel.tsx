...
const CHANGELOG: { date: string; title: string; description: string; href?: string }[] = [
  {
    date: "Jul 16, 2026",
    title: "The Semester Break Update",
    description: "A month of new features. Share boards with read-only links, see your project through rebuilt chart-based analytics, attach files to tasks, restore deleted tasks for 30 days, get push notifications, and track student contributions in the new Participation tab.",
    href: "/changelog/semester-break-update",
  },
  {
    date: "Jun 17, 2026",
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
      <nav className="w-full md:w-52 flex-shrink-0 border-b md:border-b-0 md:border-r border-border h-auto md:h-full overflow-x-auto md:overflow-y-auto py-4 md:py-7 px-3 no-scrollbar flex md:block items-center gap-1">
        ...
        {onClose && (
          <button onClick={onClose} className="md:hidden flex-shrink-0 p-1.5 rounded-lg text-muted hover:text-ink hover:bg-ink/5 transition-colors mr-1" aria-label="Close help">
